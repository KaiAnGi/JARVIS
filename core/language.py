...
RESPONSES = {
    "es": {
        ...
        "browser_already_open": "El navegador ya estaba abierto, lo puse al frente.",
        ...
        "email_delete_confirm": "Voy a eliminar el correo '{subject}'. ¿Confirmas?",
        "email_delete_cancelled": "Eliminación cancelada",
        "email_sent": "Correo enviado a {to}",
        "email_send_confirm": "Voy a enviar un correo a {to} con asunto '{subject}'. ¿Confirmas?",
        "email_send_cancelled": "Envío cancelado",
        ...
        "error": "Hubo un error al procesar tu comando.",
        "last_command": "Tu último comando fue: {text}.",
        "history_empty": "Aún no hay comandos en el historial.",
        "history_list": "Tus últimos comandos:\n{commands}",
        "history_cleared": "Historial de comandos eliminado.",
        ...
        "git_not_repo": "No estás dentro de un repositorio git",
        "git_what_commit": "¿Cuál debe ser el mensaje del commit?",
        "git_pushed": "Subido al remoto",
        "git_pulled": "Bajado del remoto",
        "git_no_commits": "No se encontraron commits",
        "git_status_result": "Estado de git: {summary}",
        "git_committed": "Commit: {msg}",
        "git_commit_confirm": "Voy a commitear {count} archivos con mensaje '{msg}'. ¿Confirmas?",
        "git_commit_cancelled": "Commit cancelado",
        "git_log_result": "Últimos {count} commits: {log}",
        "git_push_failed": "Fallo al subir: {error}",
        "git_pull_failed": "Fallo al bajar: {error}",
        "vscode_not_found": "VS Code no está instalado o no está en el PATH",
        "vscode_what_project": "¿Qué proyecto debo abrir?",
        "vscode_what_file": "¿Qué archivo debo abrir?",
        "vscode_opening": "Abriendo {name}",
        "vscode_opened": "VS Code abierto",
        "vscode_opened_dir": "VS Code abierto en el directorio actual",
        "vscode_project_not_found": "No encontré el proyecto {name}",
    },
    "en": {
        "time": "It's {time}",
        ...
        "browser_already_open": "The browser was already open, I brought it to the front.",
        ...
        "email_delete_confirm": "I will delete the email '{subject}'. Confirm?",
        "email_delete_cancelled": "Deletion cancelled",
        "email_sent": "Email sent to {to}",
        "email_send_confirm": "I will send an email to {to} with subject '{subject}'. Confirm?",
        "email_send_cancelled": "Send cancelled",
        ...
        "last_command": "Your last command was: {text}.",
        "history_empty": "There's no command history yet.",
        "history_list": "Your recent commands:\n{commands}",
        ...
        "git_not_repo": "Not inside a git repository",
        "git_what_commit": "What should the commit message be?",
        "git_pushed": "Pushed to remote",
        "git_pulled": "Pulled from remote",
        "git_no_commits": "No commits found",
        "git_status_result": "Git status: {summary}",
        "git_committed": "Committed: {msg}",
        "git_commit_confirm": "I will commit {count} files with message '{msg}'. Confirm?",
        "git_commit_cancelled": "Commit cancelled",
        "git_log_result": "Last {count} commits: {log}",
        "git_push_failed": "Push failed: {error}",
        "git_pull_failed": "Pull failed: {error}",
        "vscode_not_found": "VS Code is not installed or not in PATH",
        "vscode_what_project": "Which project should I open?",
        "vscode_what_file": "Which file should I open?",
        "vscode_opening": "Opening {name}",
        "vscode_opened": "VS Code opened",
        "vscode_opened_dir": "VS Code opened in current directory",
        "vscode_project_not_found": "Could not find project {name}",
    },
}
